...
public class RomiDrivetrain extends SubsystemBase {
  ...
  public void straightLineWithPID(double sped){
    m_diffDrive.arcadeDrive(sped, m_PIDController.calculate(-m_gyro.getAngle(), 0));
  }

  public void turnWithPID(double degrees){
    m_diffDrive.arcadeDrive(0, m_PIDController.calculate(-m_gyro.getAngle(), degrees));
  }
